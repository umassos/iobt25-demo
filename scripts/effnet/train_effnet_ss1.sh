...
python3 ./3rdparty/pytorch-image-models/train_effnet.py \
        ...
        --seed 42 \
        --epochs 100 \
        --experiment ss1-effnet-c$CUT_POINT-nn-1-$DATA \
        --run-name ss1-effnet-c$CUT_POINT-nn-1-$DATA \
        -b 64 \
        --lr 0.005 \
        --cut-point $CUT_POINT \
...
python3 ./3rdparty/pytorch-image-models/train_ensemble.py \
    ...
    --data-dir ./3rdparty/pytorch-image-models/datasets/ \
    --seed 42 \
    --checkpoint-nn1 /work/pi_shenoy_umass_edu/kgudipaty/output/ss1-effnet-c$CUT_POINT-nn-1-$DATA/model_best.pth.tar \
    --checkpoint-nn2 /work/pi_shenoy_umass_edu/kgudipaty/output/ss1-effnet-c$CUT_POINT-nn-2-$DATA/model_best.pth.tar \
    --epochs 100 \
    --experiment train-head-ss1-effnet-c$CUT_POINT-lr-0.005-cifar \
    --run-name train-head-ss1-effnet-c$CUT_POINT-lr-0.005-cifar \
    -b 64 \
    --lr 0.005\
    --loss-weights 0 0 1 \
    --contrastive-eps 0 \
