...
python3 ./3rdparty/pytorch-image-models/train_ensemble_effnet_ss2.py \
    ...
    --seed 42 \
    --epochs 100 \
    --experiment ss2-effnet-c5-nn1-2 \
    --run-name ss2-effnet-c5-nn1-2 \
    -b 64 \
    --lr 0.005\
    --loss-weights 1 1 1 \
    --contrastive-eps 0 \
...
python3 ./3rdparty/pytorch-image-models/train_ensemble_effnet_ss2.py \
    --model efficientnet_b0 \
    --dataset torch/cifar100 \
    --initial-checkpoint ./output/train/ss2-effnet-c5-nn1-2/model_best.pth.tar \
    --opt adam \
    --no-prefetcher \
    --second-half true \
    --use-contrastive false \
    ...
    --seed 42 \
    --epochs 100 \
    --experiment ss2-effnet-c5-nn2-2 \
    --run-name ss2-effnet-c5-nn2-2 \
    -b 64 \
    --lr 0.005\
    --loss-weights 1 1 1 \
    --contrastive-eps 0 \
