...
import numpy as np
import time
from system.inference_pb2 import PredictRequest
from system.inference_pb2_grpc import EncoderServiceStub

def test_server(host="localhost", port=8180, model_name="ensemble-effnet-c5-lr-0.005-tin"):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model", default="ensemble-effnet-c5-lr-0.005-tin", help="Model name")
