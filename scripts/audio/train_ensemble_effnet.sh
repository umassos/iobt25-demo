...
CUT_POINT=4
python3 ./3rdparty/pytorch-image-models/train_ensemble_effnet_audio.py \
    ...
    --seed 42 \
    --epochs 100 \
    --experiment standalone-nn12-ensemble-effnet-c$CUT_POINT-lr-0.001-speech \
    --run-name standalone-nn12-ensemble-effnet-c$CUT_POINT-lr-0.001-speech \
    -b 64 \
    --lr 0.001\
    --loss-weights 0 0 1 \
    --contrastive-eps 0 \
