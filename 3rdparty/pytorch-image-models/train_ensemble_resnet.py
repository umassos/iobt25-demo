...
from ensemble_resnet import EnsembleResnet50
...
group.add_argument("--cut-point", type=int, default=1, dest="cut_point",
                   help="Cut point of the origin efficient net")
group.add_argument("--loss-weights", type=int, nargs="+", dest="loss_weights", default=[1, 1, 1],
...
group.add_argument("--head-channels", type=int, default=1280, dest="head_channels",
                   help="Number of channels in the head layer")
