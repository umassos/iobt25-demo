...
from ensemble_vit import ViT, ViTEarly
...
def main():
    ...
    # model = ViT(image_size=224, patch_size=16, num_classes=100, dim=768, depth=12, heads=12,
        # mlp_dim=3072, pool='cls', channels=3, dim_head=64, dropout=0., emb_dropout=0.)
    model = ViTEarly(image_size=224, num_classes=100, cut_point=args.cut_point)
