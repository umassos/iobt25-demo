...
from ensemble_resnet_50 import AnytimeResnet50, Resnet50Early
...
group.add_argument("--cut-point", type=int, default=2, dest="cut_point",
...
def main():
    ...
    #                              **args.model_kwargs)
    model = Resnet50Early(num_classes=args.num_classes, cut_point=args.cut_point,
                            use_head=False, head_channels=args.head_channels)
...
def train_one_epoch(
    ...
    # Disables mixup augmentation (if provided) after certain epochs
    ...
    # Gradient accumulation setup (instead of updating weights after every batch)
