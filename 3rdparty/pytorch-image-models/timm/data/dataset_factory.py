...
from torchvision.datasets import CIFAR100, CIFAR10, MNIST, KMNIST, FashionMNIST, ImageFolder, Food101
try:
...
def create_dataset(
    ...
    if name.startswith('torch/'):
        ...
        if name in _TORCH_BASIC_DS:
            ...
            assert has_food101, 'Please update to a newer PyTorch and torchvision for Food101 dataset.'
            if split in _TRAIN_SYNONYM:
                split = 'train'
            elif split in _EVAL_SYNONYM:
                split = 'test'
