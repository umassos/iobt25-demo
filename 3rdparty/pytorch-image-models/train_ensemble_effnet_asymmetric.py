...
from ensemble_efficientnet_asymmetric import EnsembleEfficientNetAsymmetric
...
group.add_argument("--cut-point-1", type=int, default=4, dest="cut_point_1",
                   help="Cut point 1 of the original efficient net")
group.add_argument("--cut-point-2", type=int, default=4, dest="cut_point_2",
                   help="Cut point 2 of the original efficient net")
...
def main():
    ...
    #                              **args.model_kwargs)
    model = EnsembleEfficientNetAsymmetric(num_classes=args.num_classes, cut_point_1=args.cut_point_1,
                                           cut_point_2=args.cut_point_2, width_ratio=args.width_ratio,
