...
class SpeechCommandsMelDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # 5) add batch dim → (1, 1, n_mels, time)
        mel = mel.unsqueeze(0)

        # 6) resize spatial dims → (1, 1, image_size, image_size)
        mel = F.interpolate(
            mel,
...
def main():
    ...
    loader_train = make_dataloader(
        args.data_dir, args.train_split, batch_size=args.batch_size)
    loader_eval = make_dataloader(
        args.data_dir, args.val_split, batch_size=args.batch_size)
